...
cs = ax1.contourf(xx, yy, transpose(wn_t0),levels=80, cmap="YlGnBu",
...
cs = ax2.contourf(xx, yy, transpose(wn_t10),levels=80, cmap="YlGnBu",
                interpolation="bilinear")
ax2.set_title("\$ t=10\$")
plt[:subplot](ax2); cs
...
cs = ax3.contourf(xx, yy, transpose(wn_t20),levels=80, cmap="YlGnBu",
                 interpolation="bilinear")
ax3.set_title("\$ t=20\$")
plt[:subplot](ax3); cs
